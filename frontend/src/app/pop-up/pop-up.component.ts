...
export class PopUpComponent {
  ...
  ResetPassword() {
    ...
    fetch('http://localhost:4200/api/resetPassword', {
      method: 'PATCH',
      credentials: 'include',
      headers: {
  ...
  Create() {
    ...
    fetch('http://localhost:4200/api/createNewLink', {
      method: 'POST',
      credentials: 'include',
      headers: {
        'Content-Type': 'application/json',
  ...
  delete() {
    this.errorMessage = 'Please, wait...';
    fetch('http://localhost:4200/api/deleteLink', {
      method: 'DELETE',
      credentials: 'include',
      headers: {
        'Content-Type': 'application/json',
  ...
  deleteAccount() {
    this.errorMessage = 'Please, wait...';
    fetch('http://localhost:4200/api/deleteUser', {
      method: 'DELETE',
      credentials: 'include',
      headers: {
        'Content-Type': 'application/json',
  ...
  clickInfo() {
    ...
    fetch(
      `http://localhost:4200/api/GetClickInfo?short_link=${this.linkData.short_link}`,
      {
        method: 'GET',
        credentials: 'include',
        headers: {
  ...
  edit() {
    ...
    fetch('http://localhost:4200/api/editLink', {
      method: 'PATCH',
      credentials: 'include',
      headers: {
        'Content-Type': 'application/json',
  ...
  getWebhook() {
    fetch('http://localhost:4200/api/getUserData', {
      method: 'GET',
      credentials: 'include',
      headers: {
        'Content-Type': 'application/json',
